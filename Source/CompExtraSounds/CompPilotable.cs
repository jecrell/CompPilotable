...
namespace CompPilotable
{
    ...
    internal class CompPilotable : ThingComp
    {
        ...
        public void ResolveEjection()
        {
            ...
            {
                if (Find.TickManager.TicksGame % 250 == 0 || (Pawn.Dead || Pawn.Downed))
                {
                    if (Pawn.health != null)
                    {
        ...
        public override void CompTick()
        {
            ...
            ResolveEjection();
            ResolveDeadPassengers();
        }


        public CompProperties_Pilotable Props
        {
            get
            {
                return (CompProperties_Pilotable)props;
            }
        }
